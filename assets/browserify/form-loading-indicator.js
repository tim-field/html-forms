...
Loader.prototype.start = function() {
    if( this.button ) {
        // loading text
        let loadingText = this.button.getAttribute('data-loading-text');
        if( loadingText ) {
        ...
        // Show AJAX loader
        let styles = window.getComputedStyle( this.button );
...
Loader.prototype.tick = function() {
    ...
    let text = getButtonText(this.button);
    let loadingChar = this.character;
...
Loader.prototype.stop = function() {
    if( this.button ) {
        ...
        let text = getButtonText(this.originalButton);
